...
def add_to_watchlist_cache(user_id: int, thread_id: int):
    ...
    :param thread_id: The id of the thread to link with the user.
    """
...
async def get_or_fetch_watchlist_index(watch_channel: discord.TextChannel) -> dict[int, int]:
    ...
    :param watch_channel: The text channel with all the stored watchout doubt messages and threads.

    :return: A dictionary with [user_id, thread_id] for the watchout doubts.
    """
